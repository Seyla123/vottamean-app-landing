...
const typographyVariants = cva("", {
  variants: {
    variant: {
      h1: "font-sans scroll-m-20 text-5xl leading-tight lg:leading-tight font-medium tracking-tight lg:text-7xl",
      ...
      h3: "font-sans  scroll-m-20 text-2xl tracking-tight",
